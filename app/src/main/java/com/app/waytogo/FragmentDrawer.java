...
import com.app.waytogo.adapter.NavigationDrawerAdapter;
...
public class FragmentDrawer extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		editor = getActivity().getSharedPreferences(USER, Context.MODE_PRIVATE).edit();
        // drawer labels
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tv_user_profile = (TextView) layout.findViewById(R.id.tv_user_profile);
        ...
        try {
        	...
        	Picasso.with(getActivity()).load("https://graph.facebook.com/"+myPreferences.getString("strFBID", "")+"/picture?type=large").centerCrop().resize(75, 75).into(iv_profile);
        }
        
        tv_user_profile.setText(myPreferences.getString("strFirstName", "")+ " " +myPreferences.getString("strLastName", ""));
        tv_user_profile.setTypeface(tf);
